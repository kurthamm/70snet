;CBBS V3.5.0 	CBBSKILL.ASM - MESSAGE KILL
;09/13/81 21:56:04
;	LINKS TO CBBSDISK
;
;	O   O	O O O	O	O
...
;
KILL	LDA	NKILATT	;GET # ATTEMPTS
	CPI	3	;3 ALREADY?
	JZ	WHATM	;ACT LIKE KILL IS UNKNOWN
;
	IF	TWITCK
	CALL	TWITST
	JZ	WHATM
...
03	DW	00	;HELP MSG #
	...
	CALL	JUSTA	;JUSTIFY TO 5 BYTES IN MSGNO
	JC	KILL	;INVALID #
;
...
;
	LDA	PASSFLG
	ORA	A
	JZ	FUNCT	;OPERATOR NEEDS NO CR/LF
02	LDA	INBUF
02	CPI	CR
02	CNZ	CRLF	;CRLF IF STACKED COMMAND
	JMP	FUNCT
;
...
KFIXUP	CALL	KDMAWK
01	LXI	D,WKFCB	;CLOSE THE
01	MVI	C,CLOSE	;	WORK FILE
01	CALL	BDOS	;(WRITES ALLOC TO DISK)
...
04	CALL	WRCRLF
	...
	CALL	ILPRT
	DB	'I told operators you want that '
	DB	'msg killed.'
	DB	CR,LF,0
04;MODS;
	LXI	H,MSGNO
